...
function puttSetDist(v){
  ...
  renderPutt(); renderExpectedShots('es-putting', ft, 'green'); renderPuttSG();
}
...
Object.assign(window, { puttSetDist, buildPuttSVG, buildPuttProfileSVG, buildPutting, renderPutt, renderPuttSG, fmtSlopeElev, fmtPuttSlopeDeg, slopeCategoryFromElev, PUTT_BREAKS, puttBreakId, onPuttBreakSlider, onPuttGradeInput, puttSlopeTermHTML, onPuttSlopeInput, togglePuttSlopeUnit, puttElevIn, puttMakePct, puttLeave, psgDefaultHcp, psgHcpLabel, onPsgHcpInput });
