  ...
  wrap.innerHTML=
    ...
    + (G.kind==='putt'
        ? '<p class="gen-note" style="margin-top:0">This game is the exception among the four: <b>you do the putting yourself</b>, so the skill being measured is the skill the index describes. No solving is needed - the allowance is simply the difference between a handicap player\'s expected putts and scratch\'s from the same distance.</p>'
          ...
          + '<p class="gen-note"><b>Fixed 2026-09:</b> par from 3 feet used to come out at 1.20 putts, which flattered every tap-in here and every close proximity on the wedge card. The green baseline was recalibrated to the same tour benchmark the other lies already used - 1.05 from 3 feet - and now runs down to 1 foot, so a tap-in no longer scores like a 3-footer. Worth re-checking against your own make rates once there are enough rounds to measure.</p>'
